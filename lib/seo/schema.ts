 ...
 *   recorded "https://roshingel.site/about/hi@roshingel.site" as a profile
...
export function privacyPolicySchema(about: AboutData, document?: LegalDocument | null): JsonLd {
  return {
    "@context": "https://schema.org",
    "@type": "PrivacyPolicy",
    name: "Privacy Policy - roshingel.site",
    description:
      "Comprehensive privacy policy outlining how we collect, use, and protect your personal information on roshingel.site",
