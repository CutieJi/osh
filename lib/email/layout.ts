...
<span class="e-head" style="color:${LIGHT.heading};font-size:14px;font-weight:600;letter-spacing:-0.01em;font-family:${FONT};">roshingel.site</span>
</td>
</tr></table>
</td></tr>`;
}
...
Sent by <a class="e-link" href="https://roshingel.site" style="color:${LIGHT.link};text-decoration:none;">roshingel.site</a>
</p>
</td></tr>`;
}
