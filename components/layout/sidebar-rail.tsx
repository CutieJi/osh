      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-y-auto custom-scroll">
        <div className="w-full px-3 pt-8 pb-4">
          <div className="flex w-full flex-col items-start gap-0.5">
            {/*
              `eager` for the same reason the mobile navbar's copy carries it:
              from `md` up this rail is the header, and its photo is the
              largest thing painted above the fold -- Next reported it as the
              Largest Contentful Paint and asked for exactly this by name.
            */}
            <ProfileAvatar
              src={about.image_url}
              name={about.name}
