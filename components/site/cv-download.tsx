 ...
 */
const FORMATS = [
  { href: "/cv", label: "PDF", icon: DownloadIcon, external: true },
  { href: "/cv-latest", label: "Word", icon: DocumentIcon, external: true },
  { href: "/cv-copy", label: "Copy CV", icon: CopyIcon, external: true },
] as const;
