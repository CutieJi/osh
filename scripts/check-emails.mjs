...
const URL = "https://roshingel.site/guestbook/";
...
for (const [name, body] of Object.entries(rendered)) {
  check(`${name} has the brand header`, body.html.includes("roshingel.site</span>"));
  check(
    `${name} has the footer`,
    body.html.includes('Sent by <a class="e-link" href="https://roshingel.site"'),
  );
